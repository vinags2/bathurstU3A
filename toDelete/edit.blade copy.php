        ...
        <form id="mainForm" method="post" action="{{ route('person.store') }}">
            ...
            <tr>
                ...
                <tr class="nonMember"
                        ...
                        >
                    <td colspan="2">
                        <input  id="nonMember" type="checkbox" size="40" name="nonMember" @if(old('nonMember')) "checked" @endif onChange="showNonMember(this)" class="form-check-input ml-3"
                        @if ($member)
                            checked="checked"
                        @endif
                        >
                        <label class="form-check-label ml-5" for="nonMember"> <b>Emergency Contact details (eg next of kin)</b></label><td></tr>
                <tr class="nonMember"
                        @if (!$member)
                            style="display:none"
                        @endif
                ...
                <tr class="nonMember"
                        @if (!$member)
                            style="display:none"
                        @endif
                ><td colspan="2"><b>Payment Details</b></td></tr>
                <tr class="nonMember"
                        @if (!$member)
                            style="display:none"
                        @endif
                ><td colspan="2">The membership fee has been paid by:</td></tr>
                <tr class="nonMember"
                        @if (!$member)
                            style="display:none"
                        @endif
                ...
                <tr class="nonMember"
                        @if (!$member)
                            style="display:none"
                        @endif
                ><td colspan="2"><b>Newsletter delivery method</b></td></tr>
                <tr class="nonMember"
                        @if (!$member)
                            style="display:none"
                        @endif
                ><td colspan="2">The quarterly newsletters are to be delivered by:</td></tr>
                <tr class="nonMember"
                        @if (!$member)
                            style="display:none"
                        @endif

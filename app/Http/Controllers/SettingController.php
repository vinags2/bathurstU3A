...
class SettingController extends Controller
{
    ...
    public function store(Request $request) {
        if ($request->filled('SettingsPage1')) {
            ...
            return redirect()->route('termDates')
            // return redirect()->route('termDates', ['id' => 44])
                ->withSuccess('The settings have been updated successfully');
        } elseif ($request->filled('editTermDates')) {
            dd($request, 'SettingController@store');
